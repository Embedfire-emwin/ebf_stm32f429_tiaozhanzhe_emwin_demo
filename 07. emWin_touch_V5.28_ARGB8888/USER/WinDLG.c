...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateError[] = {
  { FRAMEWIN_CreateIndirect, "Error",  ID_FRAMEWIN_0, 0, 0, 190, 130, 0, 0x0, 0 },
  { BUTTON_CreateIndirect,   "OK",     ID_BUTTON_0, 20, 60, 60, 30, 0, 0x0, 0 },
  { BUTTON_CreateIndirect,   "Reboot", ID_BUTTON_1, 100, 60, 60, 30, 0, 0x0, 0 },
...
static void _cbDialogError(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_0: // Notifications sent by 'OK'
      ...
      break;
    case ID_BUTTON_1: // Notifications sent by 'Reboot'
      switch(NCode) {
      case WM_NOTIFICATION_CLICKED:
        // USER START (Optionally insert code for reacting on notification message)
        // USER END
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_NOTIFY_PARENT:
    ...
    case GUI_ID_BUTTON0: // Notifications sent by 'Button'
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
         GUI_ExecDialogBox(_aDialogCreateError,GUI_COUNTOF(_aDialogCreateError),_cbDialogError,pMsg->hWin,100,100);
        // USER END
        break;
      // USER START (Optionally insert additional code for further notification handling)
      // USER END
