...
#if SD_USE_WRITEPROTECT_PIN > 0
	return (GPIO_ReadInputDataBit(SD_WRITEPROTECT_GPIO_PORT,SD_WRITEPROTECT_PIN) == Bit_RESET);
#else
	return 1;
#endif	
}
...
{
#if SD_USE_DETECT_PIN > 0 || SD_USE_WRITEPROTECT_PIN > 0
	...
	GPIO_InitStruct.GPIO_Pin = SD_DETECT_PIN;
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IN;
	GPIO_InitStruct.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_UP;
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;
	
	GPIO_Init(SD_DETECT_GPIO_PORT, &GPIO_InitStruct);
#endif

#if SD_USE_WRITEPROTECT_PIN > 0
	
	RCC_AHB1PeriphClockCmd(SD_WRITEPROTECT_GPIO_CLK, ENABLE);
	
	GPIO_InitStruct.GPIO_Pin = SD_WRITEPROTECT_PIN;
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IN;
	GPIO_InitStruct.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_UP;
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_100MHz;
	
	GPIO_Init(SD_WRITEPROTECT_GPIO_PORT, &GPIO_InitStruct);
#endif
