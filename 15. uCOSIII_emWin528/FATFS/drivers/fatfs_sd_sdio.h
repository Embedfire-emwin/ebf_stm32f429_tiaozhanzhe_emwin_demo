...
/**
  ...
  */
#define SD_USE_DETECT_PIN                0
#define SD_DETECT_PIN                    GPIO_Pin_0
#define SD_DETECT_GPIO_PORT              GPIOE
#define SD_DETECT_GPIO_CLK               RCC_AHB1Periph_GPIOE                             


#define SD_USE_WRITEPROTECT_PIN          0
#define SD_WRITEPROTECT_PIN              PIO_Pin_1
#define SD_WRITEPROTECT_GPIO_PORT        GPIOE
#define SD_WRITEPROTECT_GPIO_CLK         RCC_AHB1Periph_GPIOE   
