...
#define UTF8_PHOTORESISTOR  "\xe5\x85\x89\xe6\x95\x8f\xe7\x94\xb5\xe9\x98\xbb\xef\xbc\x9a"//光敏电阻：
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreateWeather[] = {
  ...
  { TEXT_CreateIndirect,     "SampleValue",  GUI_ID_TEXT2,   110, 270, 100, 35,  0, 0x64,   0 }, 
  { TEXT_CreateIndirect,     "VoltageValue", GUI_ID_TEXT3,   95,  320, 75,  35,  0, 0x64,   0 },	
...
static void _cbDialogWeather(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    GUI_DispStringAt(UTF8_PHOTORESISTOR,100,237); 
    GUI_DispStringAt(UTF8_ADSAMPLEVALUE,30,280);	
	  GUI_DispStringAt(UTF8_VOLAGEVALUE,30,330);
    GUI_DispStringAt("mV",172,330);  
      ...
      OSSchedLock(&err);
        ...
        if(drv_weather.WaveTpye==0)
        {
          ...
          i=20;
			...
			drv_weather.ADC_Value=ADC_ConvertedValue*3300/4096;
			sprintf(tempstr,"0x%X",ADC_ConvertedValue);			
